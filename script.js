...
const WeatherSnap = () => {
    ...
    return (React.createElement("span", { className: "weather" },
        React.createElement("i", { className: "weather-type", className: " fa-user-circle-o" }),
        React.createElement("span", { className: "weather-temperature-value" }, temperature),
        React.createElement("span", { className: "weather-temperature-unit" }, "")));
};
const Reminder = () => {
    return (React.createElement("div", { className: "reminder" },
        React.createElement("div", { className: "reminder-icon" },
            React.createElement("i", { className: "fa-solid fa-face-smile" })),
        React.createElement("span", { className: "reminder-text" },
            "Remember to ",
            React.createElement("span", { className: "reminder-time" }, "Smile"))));
};
const Time = () => {
...
const Weather = () => {
    ...
    return (React.createElement(MenuSection, { icon: "fa fa-hand-peace-o", id: "weather-section", scrollable: false, title: "Hey Hammad! How's it goin'? " }, getDays()));
};
const Tools = () => {
    const getTools = () => {
        return [{
...
const Restaurants = () => {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-camera-movie", id: "restaurants-section", title: "Popcorn time!" }, getRestaurants()));
};
const Movies = () => {
    const getMovies = () => {
        return [{
                desc: "A Spartan warrior is sent by the Greek gods to kill Ares, the god of war.",
                id: 1,
                icon: "fa-solid fa-axe",
                image: "https://images4.alphacoders.com/115/1153100.jpg",
                title: "Warlord"
            }, {
                desc: "Outrun a train inspector who is chasing you for spray painting on trains.",
                id: 2,
                icon: "fa-solid fa-skating",
                image: "https://lh3.google.com/u/0/d/1SI3fypChMh203Y5U2qNXnHysotEkOyaX=w1128-h517-iv1",
                title: "Surf People"
            }, {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-gamepad", id: "movies-section", scrollable: true, title: "Game Time!" }, getMovies()));
};
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" },
                ...
                React.createElement("a", { id: "youtube-link", className: "clear-button", href: "https://google-redesign.netlify.app/", target: "_blank" },
                ...
                React.createElement("a", { id: "youtube-link", className: "clear-button", href: "https://discord.com/channels/@me", target: "_blank" },
                    React.createElement("i", { className: "fa-brands fa-discord" }),
